...
$jobs = [
    [
        ...
        "description" => "описание функций работы менеджером"
    ],
    [
        "name" => "Бухгалтер",
        "dateStart" => "Март 2015",
        "dateFinish" => "Сентябрь 2020", 
        "description" => "описание функций работы бухгалтера"
    ],
    [
        "name" => "Помощник бухгалтера",
        "dateStart" => "Апрель 2010",
        "dateFinish" => "Март 2015", 
        "description" => "описание функций работы помощника бухгалтера"
    ]
]
?>
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <?php for ($i = 0; $i < count($jobs); $i++):?>
                <div class="w3-container">
                    ...
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $jobs[$i]["dateStart"];?> - 
                    <?php if ($i == 0): ?>
